...
HIGH_IMR_PRCNTG = static['HIGH_IMR_PRCNTG']
DEAD_IMR_PRCNTG = static['DEAD_IMR_PRCNTG']
if sum([IMMMUNE_IMR_PRCNTG + ASYMP_IMR_PRCNTG + MOD_IMR_PRCNTG + HIGH_IMR_PRCNTG + DEAD_IMR_PRCNTG]) != 1:
    sys.exit(f"IMMMUNE_IMR_PRCNTG + ASYMP_IMR_PRCNTG + MOD_IMR_PRCNTG + HIGH_IMR_PRCNTG + DEAD_IMR_PRCNTG must sum to 1")

AGENTS_WEARING_MPRCNTG = static['AGENTS_WEARING_MASK_PRCNTG']
if AGENTS_WEARING_MPRCNTG > 1:
    sys.exit(f"AGENTS_WEARING_MPRCNTG must be less or equal to 1")
